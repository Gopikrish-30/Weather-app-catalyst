  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      const apiBaseUrl = isDevelopment 
        ? 'http://localhost:3001/server/widgetsui_function' // Catalyst local development server
        : '/server/widgetsui_function'; // Production Catalyst function URL (relative path)
